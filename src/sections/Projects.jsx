  ...
  const projects = [
    {
      ...
      description: 'End-to-end pipeline capturing form submissions, creating CRM entries, writing AI-personalized emails, and updating lead status.',
      technologies: ['n8n', 'monday.com', 'Groq'],
      metricLabel: 'Metric',
      metric: '0 manual touchpoints',
    ...
    },
    {
      ...
      description: 'Weekly automated audit of all AWS IAM users — flags accounts inactive 90+ days and posts alerts for immediate remediation.',
      technologies: ['n8n', 'AWS IAM', 'Slack'],
      metricLabel: 'Efficiency',
      metric: '100% IAM coverage weekly',
    ...
    },
    {
      ...
      description: 'Watches a Shopify store and auto-rewrites every product description into high-converting, SEO-optimized copy using fine-tuned models.',
      technologies: ['Make.com', 'OpenAI', 'Shopify'],
      metricLabel: 'Throughput',
      metric: '∞ products · 0 hrs writing',
      linkText: 'Live Case Study',
      link: '#',
      category: 'ecommerce',
      featured: false,
    ...
    },
    {
      ...
      subtitle: 'Autonomous LinkedIn Content System',
      description: 'Generates, approves, and publishes AI-written LinkedIn posts with Telegram human-in-the-loop approval triggers.',
      technologies: ['n8n', 'OpenAI', 'Telegram'],
      metricLabel: 'Output',
      metric: '4x posts · 0 min writing',
      linkText: 'Live Case Study',
      link: '#',
      category: 'ai',
      featured: false,

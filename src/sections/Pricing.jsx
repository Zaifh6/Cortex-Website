  ...
  const plans = [
    {
      ...
      monthlyPrice: 400,
      yearlyPrice: 400,
      description: 'For small teams automating their first workflows and eliminating repetitive manual tasks.',
      features: [
        { text: '1 automation workflow', included: true },
        { text: 'Up to 2 tool integrations', included: true },
        { text: '3 revision rounds / month', included: true },
        { text: 'Email support (48h response)', included: true },
        { text: 'AI agent / chatbot', included: false },
    ...
    },
    {
      ...
      monthlyPrice: 800,
      yearlyPrice: 800,
      description: 'For scaling teams that need multiple automations, AI agents, and hands-on strategic support.',
      features: [
        ...
        { text: 'Monthly 1:1 strategy call (30 min)', included: true },
    ...
    },
    {
      ...
      monthlyPrice: 1800,
      yearlyPrice: 1800,
      description: 'Full-stack automation partner for ambitious teams. Unlimited builds, dedicated engineer, weekly oversight.',
      features: [
